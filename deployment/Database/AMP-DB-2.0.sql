...
GO
INSERT [dbo].[ApplicationConfiguration] ( [Name], [Value], [Description]) VALUES ( N'ApplicationName', N'SecuriThings', N'Application Name')
GO
                     ...
                     <tr>
                        <td align="center" valign="top">
                           ...
                           <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                              <tr>
                                 <td valign="top"  class="headerContent">                                              <img  src="https://securithings.com/images/logo_2020_highres-2.png" id="headerImage" />                                          </td>
                              </tr>
                           </table>
                           <!-- // END HEADER -->                                                                                           
                        </td>
                              ...
                              <tr>
                                 <td align="center" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templatePreheader">
                                       <tr>
                                          <td valign="top" class="preheaderContent" style="padding-top: 10px; padding-right: 20px; padding-bottom: 10px; padding-left: 20px;">                                                          You are receiving this message because of an interaction with                                                          <a href="https://securithings.com/">${ApplicationName}</a>.                                                          Please contact us at <a href="https://securithings.com/company.html">${ApplicationName}</a>                                                          in case you think you have received this message in error or need help.                                                      </td>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" id="templateContainer">
                     <tr>
                        <td align="center" valign="top">
                           ...
                           <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                              <tr>
                                 <td valign="top" style="background:#F9F9F9" class="headerContent">                                              <img src="https://securithings.com/images/logo_2020_highres-2.png" id="headerImage" />                                          </td>
                              </tr>
                           </table>
                           <!-- // END HEADER -->                                                                 
                        </td>
