                           ...
                           <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                              <tr>
                                 <td valign="top" class="bodyContent">
                                    ...
                                    <p style=" margin-left: auto; margin-right: auto; text-align:right;">                                                  <a href="https://tptest-user.azurewebsites.net/">                                                      <button style="background-color:#2168A6;line-height:30px;color:white"><b>View Details</b></button>                                                  </a>                                              </p>
                     ...
                     <tr>
                        <td align="center" valign="top">
                           ...
                           <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templatePreheader">
                              <tr>
                                 <td valign="top" class="preheaderContent" style="padding-top: 10px; padding-right: 20px; padding-bottom: 10px; padding-left: 20px;">                                              You are receiving this message because of an interaction with                                              <a href="https://www.teradata.com/">${ApplicationName}</a>.                                              Please contact us at <a href="https://www.teradata.com/About-Us/Contact">${ApplicationName}</a>                                              in case you think you have received this message in error or need help.                                          </td>
