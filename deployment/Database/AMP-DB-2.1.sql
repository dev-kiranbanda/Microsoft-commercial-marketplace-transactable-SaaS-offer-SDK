...
GO
INSERT [dbo].[ApplicationConfiguration] ( [Name], [Value], [Description]) VALUES ( N'ApplicationName', N'Nutanix', N'Application Name')
GO
...
Select 'Failed','Failed',GetDate(),'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">      
                     ...
                     <tr>
                        <td align="center" valign="top">
                           ...
                           <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                              <tr>
                                 <td valign="top" class="headerContent">                                              <img src="https://1000logos.net/wp-content/uploads/2019/07/Nutanix-500x281.jpg" style="max-width: 200px; display: block; margin-left: auto; margin-right: auto; padding-top:10px;padding-bottom:10px;" id="headerImage" />                                          </td>
                              </tr>
                           </table>
                           <!-- // END HEADER -->                                                                                  
                        </td>
                           ...
                           <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                              <tr>
                                 <td valign="top" class="bodyContent">
                                    ...
                                    <p>${welcometext}</p>
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">                                                                            ${subscriptiondetails}                                                                                                                   </table>
                                    <p style=" margin-left: auto; margin-right: auto; text-align:right;">                                                  <a href="https://www.portal.azure.com">                                                      <button style="background-color:#2168A6;line-height:30px;color:white"><b>View Details</b></button>                                                  </a>                                              </p>
                              ...
                              <tr>
                                 <td align="center" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templatePreheader">
                                       <tr>
                                          <td valign="top" class="preheaderContent" style="padding-top: 10px; padding-right: 20px; padding-bottom: 10px; padding-left: 20px;">                                              You are receiving this message because of an interaction with                                              <a href="https://www.nutanix.com/en/">${ApplicationName}</a>.                                              Please contact us at <a href="https://www.nutanix.com/contact-us">${ApplicationName}</a>                                              in case you think you have received this message in error or need help.                                          </td>
...
Insert into [EmailTemplate]
Select 'PendingActivation','Pending Activation',GetDate(),'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">      
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      <!--<note>Use this Template for Pending Activation email </note>-->                      
      <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
</html>','Pending Activation','','','',1
GO

Insert into [EmailTemplate]
Select 'Subscribed','Subscribed',GetDate(),'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">      
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      <!--<note>Use this Template for Pending Activation email </note>-->                      
      <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
Insert into [EmailTemplate]
Select 'Unsubscribed','Unsubscribed',GetDate(),'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">      
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      <!--<note>Use this Template for Pending Activation email </note>-->                      
      <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
