        ...
        public override void Process(Guid subscriptionID)
        {
            ...
            if (subscription.SubscriptionStatus == SubscriptionStatusEnumExtension.PendingUnsubscribe.ToString())
            {
                try
                {
                    ...
                    this.subscriptionLogRepository.LogStatusDuringProvisioning(subscriptionID, default, DeploymentStatusEnum.DeleteResourceGroupSuccess.ToString(), "Unsubscribed", SubscriptionStatusEnumExtension.Unsubscribed.ToString());
                }
                catch (Exception ex)
                {
